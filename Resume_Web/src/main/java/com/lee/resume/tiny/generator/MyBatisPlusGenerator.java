package com.lee.resume.tiny.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        return new GlobalConfig.Builder()
                .outputDir(projectPath + "/Resume_Web/src/main/java")
                .author("lee")
                .disableOpenDir()
                .enableSwagger()
                .fileOverride()
    ...
    private static PackageConfig initPackageConfig(String projectPath,String moduleName) {
        ...
        return new PackageConfig.Builder()
                ...
                .entity("model")
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/Resume_Web/src/main/resources/mapper/" + moduleName))
                .build();
    }
